...
| Task 47 (Gym owner, ADR 0023)                  | `owner-claim-flow`, `owner-moderation-flow` | Profile 메뉴 추가 항목 + owner 라우팅 reachability. 인증/실데이터 의존 단계는 Task 48 (Apple Sign In) 후 Task 49 에서 보강. |
