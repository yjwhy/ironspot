...
public class Keys {
    ...
    public static final ForeignKey<Record, Record> GYM_MACHINES__GYM_MACHINES_GYM_ID_FKEY = Internal.createForeignKey(GymMachines.GYM_MACHINES, DSL.name("gym_machines_gym_id_fkey"), new TableField[] { GymMachines.GYM_MACHINES.GYM_ID }, Keys.GYMS_PKEY, new TableField[] { Gyms.GYMS.ID }, true);
    public static final ForeignKey<Record, Record> GYM_MACHINES__GYM_MACHINES_TEMPLATE_ID_FKEY = Internal.createForeignKey(GymMachines.GYM_MACHINES, DSL.name("gym_machines_template_id_fkey"), new TableField[] { GymMachines.GYM_MACHINES.TEMPLATE_ID }, Keys.MACHINE_TEMPLATES_PKEY, new TableField[] { MachineTemplates.MACHINE_TEMPLATES.ID }, true);
    public static final ForeignKey<Record, Record> MACHINE_PHOTOS__MACHINE_PHOTOS_GYM_MACHINE_ID_FKEY = Internal.createForeignKey(MachinePhotos.MACHINE_PHOTOS, DSL.name("machine_photos_gym_machine_id_fkey"), new TableField[] { MachinePhotos.MACHINE_PHOTOS.GYM_MACHINE_ID }, Keys.GYM_MACHINES_PKEY, new TableField[] { GymMachines.GYM_MACHINES.ID }, true);
    public static final ForeignKey<Record, Record> MACHINE_PHOTOS__MACHINE_PHOTOS_USER_ID_FKEY = Internal.createForeignKey(MachinePhotos.MACHINE_PHOTOS, DSL.name("machine_photos_user_id_fkey"), new TableField[] { MachinePhotos.MACHINE_PHOTOS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
    public static final ForeignKey<Record, Record> MACHINE_TEMPLATES__MACHINE_TEMPLATES_BRAND_ID_FKEY = Internal.createForeignKey(MachineTemplates.MACHINE_TEMPLATES, DSL.name("machine_templates_brand_id_fkey"), new TableField[] { MachineTemplates.MACHINE_TEMPLATES.BRAND_ID }, Keys.BRANDS_PKEY, new TableField[] { Brands.BRANDS.ID }, true);
    public static final ForeignKey<Record, Record> MACHINE_TEMPLATES__MACHINE_TEMPLATES_CATEGORY_ID_FKEY = Internal.createForeignKey(MachineTemplates.MACHINE_TEMPLATES, DSL.name("machine_templates_category_id_fkey"), new TableField[] { MachineTemplates.MACHINE_TEMPLATES.CATEGORY_ID }, Keys.CATEGORIES_PKEY, new TableField[] { Categories.CATEGORIES.ID }, true);
    public static final ForeignKey<Record, Record> PHOTO_VOTES__PHOTO_VOTES_PHOTO_ID_FKEY = Internal.createForeignKey(PhotoVotes.PHOTO_VOTES, DSL.name("photo_votes_photo_id_fkey"), new TableField[] { PhotoVotes.PHOTO_VOTES.PHOTO_ID }, Keys.MACHINE_PHOTOS_PKEY, new TableField[] { MachinePhotos.MACHINE_PHOTOS.ID }, true);
    public static final ForeignKey<Record, Record> PHOTO_VOTES__PHOTO_VOTES_USER_ID_FKEY = Internal.createForeignKey(PhotoVotes.PHOTO_VOTES, DSL.name("photo_votes_user_id_fkey"), new TableField[] { PhotoVotes.PHOTO_VOTES.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
    public static final ForeignKey<Record, Record> REPORTS__REPORTS_DISPOSED_BY_FKEY = Internal.createForeignKey(Reports.REPORTS, DSL.name("reports_disposed_by_fkey"), new TableField[] { Reports.REPORTS.DISPOSED_BY }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
    public static final ForeignKey<Record, Record> REPORTS__REPORTS_USER_ID_FKEY = Internal.createForeignKey(Reports.REPORTS, DSL.name("reports_user_id_fkey"), new TableField[] { Reports.REPORTS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
}
