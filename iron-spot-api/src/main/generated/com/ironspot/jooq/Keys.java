...
public class Keys {
    ...
    public static final UniqueKey<Record> MACHINE_SERIES_BRAND_ID_NAME_KEY = Internal.createUniqueKey(MachineSeries.MACHINE_SERIES, DSL.name("machine_series_brand_id_name_key"), new TableField[] { MachineSeries.MACHINE_SERIES.BRAND_ID, MachineSeries.MACHINE_SERIES.NAME }, true);
    public static final UniqueKey<Record> MACHINE_SERIES_PKEY = Internal.createUniqueKey(MachineSeries.MACHINE_SERIES, DSL.name("machine_series_pkey"), new TableField[] { MachineSeries.MACHINE_SERIES.ID }, true);
    ...
    public static final ForeignKey<Record, Record> MACHINE_SERIES__MACHINE_SERIES_BRAND_ID_FKEY = Internal.createForeignKey(MachineSeries.MACHINE_SERIES, DSL.name("machine_series_brand_id_fkey"), new TableField[] { MachineSeries.MACHINE_SERIES.BRAND_ID }, Keys.BRANDS_PKEY, new TableField[] { Brands.BRANDS.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<Record, Record> MACHINE_TEMPLATES__MACHINE_TEMPLATES_SERIES_ID_FKEY = Internal.createForeignKey(MachineTemplates.MACHINE_TEMPLATES, DSL.name("machine_templates_series_id_fkey"), new TableField[] { MachineTemplates.MACHINE_TEMPLATES.SERIES_ID }, Keys.MACHINE_SERIES_PKEY, new TableField[] { MachineSeries.MACHINE_SERIES.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
