...
public class StDumppoints extends TableImpl<GeometryDumpRecord> {
    ...
    /**
     * The column <code>public.st_dumppoints.path</code>.
     */
    ...
    private StDumppoints(Name alias, Table<GeometryDumpRecord> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.GEOMETRY)
        });
    }

    private StDumppoints(Name alias, Table<GeometryDumpRecord> aliased, Field<?>[] parameters) {
        this(alias, aliased, parameters, null);
    }

    private StDumppoints(Name alias, Table<GeometryDumpRecord> aliased, Field<?>[] parameters, Condition where) {
