...
public class Brands extends TableImpl<Record> {
    ...
    public Brands where(Condition condition) {
        return new Brands(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Brands whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Brands whereNotExists(TableLike<?> select) {
