...
public class StDump extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> ST_DUMP_ = createField(DSL.name("st_dump"), DefaultDataType.getDefaultDataType("\"geometry_dump\""), this, "");

    private StDump(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.GEOMETRY)
        });
    }

    private StDump(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        this(alias, aliased, parameters, null);
    }

    private StDump(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
