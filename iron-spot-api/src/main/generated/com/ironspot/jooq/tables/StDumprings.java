...
public class StDumprings extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> ST_DUMPRINGS_ = createField(DSL.name("st_dumprings"), DefaultDataType.getDefaultDataType("\"geometry_dump\""), this, "");

    private StDumprings(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.GEOMETRY)
        });
    }

    private StDumprings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        this(alias, aliased, parameters, null);
    }

    private StDumprings(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
