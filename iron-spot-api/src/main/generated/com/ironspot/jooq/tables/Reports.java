...
public class Reports extends TableImpl<Record> {
    ...
    public Reports where(Condition condition) {
        return new Reports(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Reports whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Reports whereNotExists(TableLike<?> select) {
