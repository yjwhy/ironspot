...
import type { ApiResponseUserResponse, ApiResponseVoid, UpdateUserRequest } from '../model';
...
export type GetMeQueryError = ApiResponseVoid;

export function useGetMe<TData = Awaited<ReturnType<typeof getMe>>, TError = ApiResponseVoid>(
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getMe>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<
...
export const getUpdateMeMutationOptions = <TError = ApiResponseVoid, TContext = unknown>(options?: {
...
export type UpdateMeMutationError = ApiResponseVoid;

export const useUpdateMe = <TError = ApiResponseVoid, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof updateMe>>,
      TError,
...
export const getDeleteMeMutationOptions = <TError = ApiResponseVoid, TContext = unknown>(options?: {
...
export type DeleteMeMutationError = ApiResponseVoid;

export const useDeleteMe = <TError = ApiResponseVoid, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteMe>>, TError, void, TContext>;
    request?: SecondParameter<typeof apiClient>;
  },
